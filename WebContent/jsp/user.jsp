...
<form method="POST" action="UnderPressureServlet">
	...
	<div class="slot" id="power">
		...
		<span class="slotKey">Z</span> <input name="<% out.print(props.getProperty("userStromRowField")); %>" class="textfield" type="text" value="<% out.print(stromValueRow); %>" disabled /> 
		<span class="slotKey">S</span> <input name="<% out.print(props.getProperty("userStromColField")); %>" class="textfield" type="text" value="<% out.print(stromValueColumn); %>" disabled />
	</div>
	...
	<div class="slot" id="depth">
		...
		<span class="slotKey">Z</span> <input name="<% out.print(props.getProperty("userDepthRowField")); %>" class="textfield" type="text" value="<% out.print(depthValueRow); %>" disabled /> 
		<span class="slotKey">S</span> <input name="<% out.print(props.getProperty("userDepthColField")); %>" class="textfield" type="text" value="<% out.print(depthValueColumn); %>" disabled />
	</div>
	...
	<div class="slot" id="temperature">
		...
		<span class="slotKey">Z</span> <input name="<% out.print(props.getProperty("userWaterTemperatureRowField")); %>" class="textfield" type="text" value="<% out.print(waterTemperatureValueRow); %>" disabled /> 
		<span class="slotKey">S</span> <input name="<% out.print(props.getProperty("userWaterTemperatureColField")); %>" class="textfield" type="text" value="<% out.print(waterTemperatureValueColumn); %>" disabled />
	</div>
	...
	<div class="slot" id="deepflight-power">
		...
		<span class="slotKey">Z</span> <input name="<% out.print(props.getProperty("userDeepflightPowerRowField")); %>" class="textfield" type="text" value="<% out.print(deepflightPowerValueRow); %>" disabled /> 
		<span class="slotKey">S</span> <input name="<% out.print(props.getProperty("userDeepflightPowerColField")); %>" class="textfield" type="text" value="<% out.print(deepflightPowerValueColumn); %>" disabled />
	</div>
</form>